...
function renderFeaturedService(service, index) {
    ...
    return `
        ...
        price: basePrice
                        ...
                        <button class="buy-now-btn btn-outline px-10 py-4 text-lg" 
    ...
    return `
                ...
                <div class="p-6 flex flex-col flex-grow">
                    ...
                    <div class="mt-auto pt-4 border-t border-white/5 space-y-3">
                        <div class="grid grid-cols-2 gap-2">
                            <button class="add-to-cart px-4 py-2 bg-white/5 hover:bg-white/10 text-white font-bold text-[10px] uppercase tracking-wider rounded-lg border border-white/5 transition-all" 
        ...
        price: basePrice
                            ...
                            <a href="service-details.html?id=${service.id}" 
                               class="flex items-center justify-center px-4 py-2 bg-white/5 hover:bg-white/10 text-muted font-bold text-[10px] uppercase tracking-wider rounded-lg border border-white/5 transition-all" 
                               onclick="logServiceView('${service.id}', '${service.title}')">
                                SPECS
                            </a>
                        </div>
                        <button class="buy-now-btn w-full px-4 py-3 btn-primary text-xs uppercase tracking-wider" 
                                data-product-data='${JSON.stringify({
        id: service.id,
        title: service.title,
        image: service.image,
