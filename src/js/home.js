        ...
        return `
            ...
            price: basePrice
                ...
                <div class="p-6 flex flex-col flex-grow border-t border-white/5">
                    ...
                    <div class="price-button-wrapper mt-auto">
                        <span class="price-text text-xl font-black text-white font-outfit">${startPrice}</span>
                        <button class="buy-now-btn btn-primary py-3 text-[10px] tracking-[0.2em]" 
                                data-product-data='${JSON.stringify({
            id: item.id,
            title: item.title,
            image: item.image,
            price: basePrice
                    ...
                    <a href="public/pages/service-details.html?id=${item.id}" 
                       class="block text-center text-[10px] font-black uppercase tracking-[0.2em] text-muted hover:text-accent transition-colors">
                        VIEW SPECS
                    </a>
                </div>
            </div>
